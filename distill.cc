...
int main(int argc, char **argv)
{
	...
	// define RP ids
	unsigned int rpId_L_1_F = 0, rpId_L_1_N = 0, rpId_R_1_N = 0, rpId_R_1_F = 0;

	if (diagonal == ad45b_56b)
	{
		rpId_L_1_F = 5; rpId_L_1_N = 1; rpId_R_1_N = 101; rpId_R_1_F = 105;
	}

	if (diagonal == d45b_56t)
	{
		rpId_L_1_F = 5; rpId_L_1_N = 1; rpId_R_1_N = 100; rpId_R_1_F = 104;
	}

	if (diagonal == d45t_56b)
	{
		rpId_L_1_F = 4; rpId_L_1_N = 0; rpId_R_1_N = 101; rpId_R_1_F = 105;
	}

	if (diagonal == ad45t_56t)
	{
		rpId_L_1_F = 4; rpId_L_1_N = 0; rpId_R_1_N = 100; rpId_R_1_F = 104;
	}
	...
	t_out->Branch("v_L_1_N", &ev.h.L_1_N.v); t_out->Branch("x_L_1_N", &ev.h.L_1_N.x); t_out->Branch("y_L_1_N", &ev.h.L_1_N.y);

	t_out->Branch("v_R_1_N", &ev.h.R_1_N.v); t_out->Branch("x_R_1_N", &ev.h.R_1_N.x); t_out->Branch("y_R_1_N", &ev.h.R_1_N.y);
	...
	for (event.toBegin(); ! event.atEnd(); ++event)
	{
		...
		ev.h.L_1_N.v = false; ev.h.L_1_N.x = 0.; ev.h.L_1_N.y = 0.;
		ev.h.R_1_N.v = false; ev.h.R_1_N.x = 0.; ev.h.R_1_N.y = 0.;
		...
		for (const auto &tr : *tracks)
		{
			...
			if (rpDecId == rpId_L_1_N)
			{
				ev.h.L_1_N.v = true; ev.h.L_1_N.x = tr.getX(); ev.h.L_1_N.y = tr.getY();
			}

			if (rpDecId == rpId_R_1_N)
			{
				ev.h.R_1_N.v = true; ev.h.R_1_N.x = tr.getX(); ev.h.R_1_N.y = tr.getY();
			}
		...
		// accept event ?
		// NB: 56-210-nr not functional
		bool accept = (ev.h.L_1_F.v && ev.h.L_1_N.v && ev.h.R_1_F.v);
