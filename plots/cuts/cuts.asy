...
real lim_x_low[] = { -600, -600, -1000, -1000, -15, -8, -200, -600 };
real lim_x_high[] = { +600, 600, +1000, +1000, +15, +8, +200, +600 };

real lim_y_low[] = { -600, -600, -0.8, -0.8, -0.5, -1.2, -0.2, -4 };
real lim_y_high[] = { +600, 600, +0.8, +0.8, +0.5, +1.2, +0.2, +4 };
